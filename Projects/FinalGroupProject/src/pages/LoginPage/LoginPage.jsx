      ...
      <div className="login-card">
        ...
        <form className="login-form" onSubmit={handleSubmit} noValidate>
          <div className="form-group">
            <label htmlFor="username-input" className="form-label">Display Name</label>
            <input
              id="username-input"
              type="text"
            ...
            />
            {error && (
              <p id="username-error" className="form-error" role="alert">{error}</p>
            )}
          </div>
          <button type="submit" className="btn-primary btn-block">Enter StockPulse</button>
        </form>
